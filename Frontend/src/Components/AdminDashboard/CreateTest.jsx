...
export default function CreateTest(props) {
    ...
    const submit = async (e) => {
        e.preventDefault();
        // Notify parent component to update the test list
        props.onSave({ ...testForm, questionList: questions });
        ...
        setTestForm({ admin: { adminId: props.adminId }, testName: "", questionList: [] });
        setQuestions([]);
    }

    useEffect(() => {
        setTestForm(prevTestForm => ({ ...prevTestForm, questionList: questions }));
    }, [questions]);
    ...
    return (
        <Container className='my-5' style={{ backgroundColor: 'rgba(255, 255, 255, 0.9)', overflowY: "scroll", maxHeight: "70vh" }}>
            <Form onSubmit={submit}>
                        ...
                        <Card className='m-1 p-2'>
                            <Card.Header>
                                <Row className="justify-content-center">
                                    ...
                                    <Col md="auto">
                                        <button className="float-right mb-2 btn-sm btn-danger" onClick={(e) => removeFields(e, index)}>Delete</button>
                                    </Col>
                                </Row>
                            </Card.Header>
                            <Card.Body>
                ...
                <Row className='py-2 text-center'>
                    <Col>
                        <button className="btn btn-primary" type='submit'>Save Test</button>
                    </Col>
                    <Col>
