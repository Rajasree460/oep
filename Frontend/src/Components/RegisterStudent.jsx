...
export default function RegisterStudent(props) {
    ...
    const valudationSchema = Yup.object({
        ...
        pass: Yup.string().required("Password is required").min(8, "Password must be 8 digit long")
        .matches(
        /[!@#$%^&*(),.?":{}|<>]/,
    ...
    const submit = async (e) => {
        ...
        try{
            await valudationSchema.validate(student, {abortEarly:false})
                                ...
                                <form className="user" onSubmit={submit} method="post" autoComplete="off">
                                    <div className="form-group">
                                        <input
                                            ...
                                            {<div style={{color:'red', fontSize:'15px'}}>{errors.studentName}</div>}
                                    </div>
                                    <div className="form-group">
                                        <input
                                            type="email"
                                    ...
                                    <div className="form-group row">
                                        <div className="col-sm-6 mb-3 mb-sm-0">
                                            <input
                                                ...
                                                {<div style={{color:'red', fontSize:'15px'}}>{errors.mobNo}</div>}
                                        </div>
                                        <div className="col-sm-6">
                                            <input
                                                ...
                                                {<div style={{color:'red', fontSize:'15px'}}>{errors.pass}</div>}
                                        </div>
                                    </div>
                                    <div className="form-group row">
                                        <div className="col-sm-6 mb-3 mb-sm-0">
